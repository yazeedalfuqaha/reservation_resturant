                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <div class="w-full bg-gray-200 rounded-full">
                                <div
                                    class="w-40 p-1 text-l font-large leading-none text-center text-blak-100 bg-green-600 rounded-full">
                                    Step1</div>
                            </div>
                            ...
                            <form method="POST" action="{{ route('reservations.store.step.one') }}">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="email" class="block text-sm font-medium text-blak-700"> Email </label>
                                    <div class="mt-1">
                                        <input type="email" id="email" name="email"
                                            value="{{ $reservation->email ?? '' }}"
                                            class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                ...
                                <div class="mt-6 p-4 flex justify-end">
                                    <button type="submit"
                                        class="px-4 py-2 bg-green-600 hover:bg-green-700 rounded-lg text-white">Next</button>
                                </div>
                            </form>
                        </div>
                    </div>
